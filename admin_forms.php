                    ...
                    <tbody>
                        <?php if ($result->num_rows > 0): ?>
                            <?php while ($row = $result->fetch_assoc()): ?>
                                <?php $getuser = $row['id'] ?>
                                <?php
                                $getuserdetails_sql = "SELECT Name FROM users WHERE user_id = " . $row['user_id'];
                                $getuserdetails_result = mysqli_query($conn, $getuserdetails_sql);
                                ?>
                                <tr>
                                    <td><?= $getuser ?></td>
                                    ...
                                    <td>
                                        <?php
                                        if ($getuserdetails_result && mysqli_num_rows($getuserdetails_result) > 0) {
                                            $user_row = mysqli_fetch_assoc($getuserdetails_result);
