...
if (!isset($_SESSION['name'])) {
    header("Location: ../balajiadmin/form.php"); // Redirect to login if not logged in
    exit();
}?>
    ...
    <?php if ($result->num_rows > 0): ?>
        <?php while ($row = $result->fetch_assoc()): ?>
            <tr>
                ...
                <td><a href='view_user.php?user_name="<?= $row['Name'] ?>"' class="btn btn-primary">View User</a></td>
                <td>
